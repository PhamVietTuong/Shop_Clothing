        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (flag == 1)
                {
                    ...
                    string manv = cmbTenNV.SelectedValue.ToString();
                    string makh = lblTenKhachHang.Text;
                    ...
                    if (c.UpdateData(sqlHoaDonBan) > 0)
                    {
                        ...
                        for (int i = 0; i < dgv_CTHoaDon.Rows.Count - 1; i++)
                        {
                            ...
                            if (c.UpdateData(sqlchitiethoadonban) > 0)
                            {
                                ...
                                string update = "update sanpham set soluong = soluong - " + soluong + " where masp = '"+macthdban+"'";

                                c.UpdateData(update);

                                update = "update sanpham set soluong = soluong - " + soluong + " where mahdban = '" + maspUpdate[1] + "'";
                ...
                //    //sql = "insert into sanpham values('" + masp + "','" + tensp + "','" + mancc + "','" + maloai + "','" + mau + "','" + size + "','" + mota + "','" + hinh + "'," + soluong + "," + gianhap + "," + giaban + ", " + trangthai + ")";
                //    sql = "update hoadonban set manv = '" + manv + "', makh = '" + makh + "', ngaylaphd = '" + ngaylaphd + "',  tongtien  = '" + tongtien + "',  phone  = '" + phone + ", trangthai = " + cmbTinhTrang.SelectedIndex + "where mahdban = '" + mahdban + "'";
                ...
                //            string macthdban = dgv_CTHoaDon.Rows[i].Cells[0].Value.ToString();
                //            string masp = dgv_CTHoaDon.Rows[i].Cells[1].Value.ToString();
                //            string soluong = dgv_CTHoaDon.Rows[i].Cells[2].Value.ToString();
                //            string dongia = dgv_CTHoaDon.Rows[i].Cells[3].Value.ToString();
                //            string thanhtien = dgv_CTHoaDon.Rows[i].Cells[4].Value.ToString();
                //            string khuyenmai = dgv_CTHoaDon.Rows[i].Cells[5].Value.ToString();

                //            string sqlchitiethoadonban = "update chitiethoadonban set masp = '" + masp + "', soluong = '" + soluong + "', dongia = '" + dongia + "',  thanhtien  = '" + thanhtien + "',  khuyenmai  = '" + khuyenmai + ", trangthai = " + cmbTinhTrang.SelectedIndex + "where mahdban = '" + mahdban + "'";
                ...
                //    sql = "update hoadonban set trangthai = 1 where mahdban = '" + mahdban + "'";
                ...
                //            string sqlchitiethoadonban = "update chitiethoadonban set trangthai = 1 where masp = '" + masp + "'";
